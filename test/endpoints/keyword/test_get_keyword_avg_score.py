...
class Test(BaseTest):
    ...
    def test_get_keyword_avg_score_unauthorized(self):
        ...
        self.assertEqual(response.status_code, 404, 'The user should have not been authorized get the avg score of the keyword')
    ...
    def test_get_keyword_avg_score_content(self):
        ...
        self.assertEqual(response_data, score, 'The avg score should equal the expected score')
