...
class Test(BaseTest):
    ...
    def test_get_keywords_no_keywords(self):
        ...
        self.assertEqual(
            response.status_code, 200, "The request should have been accepted"
        )
        ...
        self.assertEqual(
            response_data,
            expected_data,
            "The data returned should match what was expected",
        )
    ...
    def test_get_keywords_with_keywords(self):
        ...
        self.assertEqual(
            response_data[0]["_id"]["$oid"],
            str(keyword_id),
            "The returned keyword should match the one inserted",
        )
    ...
    def test_get_keywords_wrong_user(self):
        ...
        response = self.send_request(
            self.user_2
        )  # But we are requesting keywords using user 2
